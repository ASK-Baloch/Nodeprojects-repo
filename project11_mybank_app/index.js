...
await welcome();
console.log(`${chalk.bgWhiteBright.blueBright(`
  :::====  :::====  :::= === :::  ===      :::====  :::====  :::==== 
  :::  === :::  === :::===== ::: ===       :::  === :::  === :::  ===
  =======  ======== ======== ======        ======== =======  ======= 
  ===  === ===  === === ==== === ===       ===  === ===      ===     
...
class BankAccount {
    ...
    accountId;
    balance;
    constructor(firstName, lastName, gender, age, accountId) {
...
async function createAccount() {
    ...
    const account = new BankAccount(answers.firstName, answers.lastName, answers.gender, parseInt(answers.age), parseInt(answers.accountId));
